# Contributing to `coolms/field-bundle`
...
`coolms/field-bundle` is a **platform package** -- it builds on `coolms/core` and only
...
`coolms/field-bundle 2.0.0` does not assert that this package broke something; it
